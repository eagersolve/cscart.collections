...
$config['db_name'] = 'cscart_collections';
$config['db_user'] = 'root';
$config['db_password'] = '151127';
...
$config['http_host'] = 'cscart.collections';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'cscart.collections';
$config['https_path'] = '';
