<?php /* Smarty version Smarty-3.1.21, created on 2022-04-12 17:01:13
         compiled from "C:\Users\igorekeek\htdocs\cscart.collections\design\backend\templates\views\products\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:343113861625586293a3890-59726998%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4bd965e1053cd19c83d691a4e6e72fc8b80520c0' => 
    array (
      0 => 'C:\\Users\\igorekeek\\htdocs\\cscart.collections\\design\\backend\\templates\\views\\products\\manage.tpl',
      1 => 1643359490,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '343113861625586293a3890-59726998',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_625586298e19c4_47716555',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_625586298e19c4_47716555')) {function content_625586298e19c4_47716555($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/Users/igorekeek/htdocs/cscart.collections/app/functions/smarty_plugins\\function.script.php';
...
if (!is_callable('smarty_modifier_to_json')) include 'C:/Users/igorekeek/htdocs/cscart.collections/app/functions/smarty_plugins\\modifier.to_json.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('position_short','name','sku','price','list_price','purchased_qty','subtotal_sum','quantity','status','products_are_not_selectable_for_context_menu','name','price','list_price','purchased_qty','subtotal_sum','quantity','edit','delete','status','no_data','text_select_fields2edit_note','cancel','modify_selected','clone_selected','export_selected','global_update','bulk_product_addition','product_subscriptions','export_found_products','import_products','create_new_product','add_product','select_fields_to_edit','products'));
?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
                ...
                <th width="<?php if ($_smarty_tpl->tpl_vars['show_update_for_all']->value) {?>16%<?php } else { ?>13%<?php }?>"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=price&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'UTF-8');?>
...
$_tmp2=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("delete"),'class'=>"cm-confirm",'href'=>"products.delete?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']).$_tmp2,'method'=>"POST"));?>
