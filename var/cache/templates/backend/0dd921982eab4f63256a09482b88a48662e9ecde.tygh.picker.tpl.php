<?php /* Smarty version Smarty-3.1.21, created on 2022-04-12 17:01:29
         compiled from "C:\Users\igorekeek\htdocs\cscart.collections\design\backend\templates\pickers\orders\picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19271393976255863934d861-70692628%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0dd921982eab4f63256a09482b88a48662e9ecde' => 
    array (
      0 => 'C:\\Users\\igorekeek\\htdocs\\cscart.collections\\design\\backend\\templates\\pickers\\orders\\picker.tpl',
      1 => 1643359490,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19271393976255863934d861-70692628',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62558639502545_84308756',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62558639502545_84308756')) {function content_62558639502545_84308756($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\Users\\igorekeek\\htdocs\\cscart.collections\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
...
$_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_id'=>"opener_picker_".((string)$_smarty_tpl->tpl_vars['data_id']->value),'but_onclick'=>"Tygh."."$".".cePicker('delete_js_item', '".((string)$_smarty_tpl->tpl_vars['data_id']->value)."', 'delete_all', 'o'); Tygh."."$".".cePicker('check_items_qty', '".((string)$_smarty_tpl->tpl_vars['data_id']->value)."', '".$_tmp2."', ".((string)$_smarty_tpl->tpl_vars['max_displayed_qty']->value)."); return false;",'but_text'=>(($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("clear") : $tmp),'but_role'=>"action",'but_icon'=>"icon-repeat",'but_target_id'=>"content_".((string)$_smarty_tpl->tpl_vars['data_id']->value)), 0);?>
...
_no_item"<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?> class="hidden"<?php }?>>
            <tr class="no-items">
                <td colspan="<?php if (!$_smarty_tpl->tpl_vars['view_only']->value) {?>6<?php } else { ?>5<?php }?>" data-th="&nbsp;"><p><?php echo (($tmp = @$_smarty_tpl->tpl_vars['no_item_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("no_items") : $tmp);?>
</p></td>
            </tr>
            </tbody>
        </table>
