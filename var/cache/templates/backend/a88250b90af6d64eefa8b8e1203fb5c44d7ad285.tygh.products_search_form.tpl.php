<?php /* Smarty version Smarty-3.1.21, created on 2022-04-12 17:01:27
         compiled from "C:\Users\igorekeek\htdocs\cscart.collections\design\backend\templates\views\products\components\products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24528631562558637c4b8a0-07145577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a88250b90af6d64eefa8b8e1203fb5c44d7ad285' => 
    array (
      0 => 'C:\\Users\\igorekeek\\htdocs\\cscart.collections\\design\\backend\\templates\\views\\products\\components\\products_search_form.tpl',
      1 => 1643359490,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '24528631562558637c4b8a0-07145577',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62558637ed2ea0_12787864',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62558637ed2ea0_12787864')) {function content_62558637ed2ea0_12787864($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include 'C:/Users/igorekeek/htdocs/cscart.collections/app/functions/smarty_plugins\\function.array_to_fields.php';
...
" onfocus="this.select();" class="input-small" />
    ...
    <div class="sidebar-field">
        ...
        <?php if (is_array($_smarty_tpl->tpl_vars['search']->value['cid'])) {?>
            <?php $_smarty_tpl->tpl_vars['s_cid'] = new Smarty_variable((smarty_modifier_count($_smarty_tpl->tpl_vars['search']->value['cid']))===1 ? (reset($_smarty_tpl->tpl_vars['search']->value['cid'])) : (0), null, 0);?>
        <?php } else { ?>
        ...
        <?php if (fn_show_picker("categories",(defined('CATEGORY_THRESHOLD') ? constant('CATEGORY_THRESHOLD') : null))) {?>
            <div class="controls">
            <?php echo $_smarty_tpl->getSubTemplate ("views/categories/components/picker/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('input_name'=>"cid",'show_advanced'=>true,'multiple'=>false,'show_empty_variant'=>true,'item_ids'=>array($_smarty_tpl->tpl_vars['s_cid']->value),'empty_variant_text'=>$_smarty_tpl->__("all_categories"),'dropdown_css_class'=>"object-picker__dropdown--categories"), 0);?>
