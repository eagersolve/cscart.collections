<?php /* Smarty version Smarty-3.1.21, created on 2022-04-12 17:08:27
         compiled from "C:\Users\igorekeek\htdocs\cscart.collections\design\themes\responsive\templates\addons\product_reviews\views\product_reviews\components\product_reviews_stars.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1014870323625587db19fe04-27683759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9f102839ffceb20373e4f4748464f9d6c1478b7a' => 
    array (
      0 => 'C:\\Users\\igorekeek\\htdocs\\cscart.collections\\design\\themes\\responsive\\templates\\addons\\product_reviews\\views\\product_reviews\\components\\product_reviews_stars.tpl',
      1 => 1649771851,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1014870323625587db19fe04-27683759',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_625587db32f2e7_26385542',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_625587db32f2e7_26385542')) {function content_625587db32f2e7_26385542($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include 'C:/Users/igorekeek/htdocs/cscart.collections/app/functions/smarty_plugins\\function.set_id.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['rating']->value>0) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['link']->value) {?>
        <?php ob_start();
echo $_smarty_tpl->__("product_reviews.show_rating");
$_tmp14=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp14.".", null, 0);?>
    <?php } elseif ($_smarty_tpl->tpl_vars['button']->value) {?>
        <?php ob_start();
echo $_smarty_tpl->__("product_reviews.click_to_see_reviews");
$_tmp15=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['title']->value).". ".$_tmp15.".", null, 0);?>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['link']->value===true) {?>
        <?php $_smarty_tpl->tpl_vars['link'] = new Smarty_variable("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."&selected_section=product_reviews#product_reviews", null, 0);?>
    <?php }?>
